...
<div class="cookie-card" id="cookie_card">
    <div class="head-section">
        <span class="cookie-title">🍪 {{__('home.cookie_head')}}</span>
    </div>
    ...
    <div class="button-section">
        <div class="accept-section">
            <button class="accept-button" id="accept_all">{{__('home.cookie_accept_all')}}</button>
            <button class="accept-button" id="accept_necessary">{{__('home.cookie_accept_necessary')}}</button>
        </div>
    </div>
