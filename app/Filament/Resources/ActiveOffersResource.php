...
use App\Filament\Resources\Actions\RefreshOfferIdAction;
...
class ActiveOffersResource extends Resource
{
    protected static ?string $model = Offers::class;

    protected static ?string $navigationIcon = 'heroicon-o-check-circle';
    protected static ?string $navigationLabel = 'Active Offers';
    ...
    {
        return [
            'index' => Pages\ListActiveOffers::route('/'),
...
//            'edit' => Pages\EditOffers::route('/{record}/edit'),
    ...
    {
        return __('admin_settings.active_offers');
    }
