...
use App\Filament\Resources\InactiveOffersResource;
...
class ListInactiveOffers extends ListRecords
{
    protected static string $resource = InactiveOffersResource::class;
...
//                }),
    ...
    {
        return Offers::query()->where('is_active',0);
    }
}
