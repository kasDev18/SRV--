...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-actions::components.actions','data' => ['actions' => $this->getCachedHeaderActions(),'class' => 'shrink-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="filament-fullcalendar" wire:ignore ax-load
            ax-load-src="<?php echo e(\Filament\Support\Facades\FilamentAsset::getAlpineComponentSrc('filament-fullcalendar-alpine', 'saade/filament-fullcalendar')); ?>"
...
<?php endif; ?>
<?php /**PATH /home/srv68915/domains/srv68915.seohost.com.pl/public_html/vendor/saade/filament-fullcalendar/src/../resources/views/fullcalendar.blade.php ENDPATH**/ ?>